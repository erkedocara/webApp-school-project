...
import al.cara.school.web.domain.Employee;
import al.cara.school.web.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link al.cara.school.web.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
